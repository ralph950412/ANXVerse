...
# instance fields
.field public final completer:Ljava8/util/concurrent/CountedCompleter;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method public constructor <init>(Ljava8/util/concurrent/CountedCompleter;I)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public complete(Ljava/lang/Object;)V
    ...
    iget-object p1, p0, Ljava8/util/concurrent/CountedCompleter;->completer:Ljava8/util/concurrent/CountedCompleter;

    if-eqz p1, :cond_0

    invoke-virtual {p1}, Ljava8/util/concurrent/CountedCompleter;->tryComplete()V
...
.method public final getPendingCount()I
    ...
    iget v0, p0, Ljava8/util/concurrent/CountedCompleter;->pending:I
...
.method public final getRoot()Ljava8/util/concurrent/CountedCompleter;
    ...
    :goto_0
    iget-object v1, v0, Ljava8/util/concurrent/CountedCompleter;->completer:Ljava8/util/concurrent/CountedCompleter;
...
.method public internalPropagateException(Ljava/lang/Throwable;)V
    ...
    :goto_0
    invoke-virtual {v0, p1, v1}, Ljava8/util/concurrent/CountedCompleter;->onExceptionalCompletion(Ljava/lang/Throwable;Ljava8/util/concurrent/CountedCompleter;)Z
    ...
    iget v2, v1, Ljava8/util/concurrent/ForkJoinTask;->status:I

    if-ltz v2, :cond_0

    invoke-virtual {v1, p1}, Ljava8/util/concurrent/ForkJoinTask;->recordExceptionalCompletion(Ljava/lang/Throwable;)I
...
.method public final propagateCompletion()V
    ...
    :cond_0
    :goto_0
    iget v4, v6, Ljava8/util/concurrent/CountedCompleter;->pending:I

    if-nez v4, :cond_2

    iget-object v0, v6, Ljava8/util/concurrent/CountedCompleter;->completer:Ljava8/util/concurrent/CountedCompleter;

    if-nez v0, :cond_1

    invoke-virtual {v6}, Ljava8/util/concurrent/ForkJoinTask;->quietlyComplete()V
...
.method public final tryComplete()V
    ...
    invoke-virtual {v6, v7}, Ljava8/util/concurrent/CountedCompleter;->onCompletion(Ljava8/util/concurrent/CountedCompleter;)V
