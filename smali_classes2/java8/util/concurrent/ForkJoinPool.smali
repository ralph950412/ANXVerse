...
.field public static final ACTCLASS:Ljava/lang/Class;
...
.field public static final ADD_WORKER:J = 0x800000000000L

.field public static final ASHIFT:I

.field public static final COMMON_MAX_SPARES:I

.field public static final COMMON_PARALLELISM:I

.field public static final CTL:J

.field public static final DEFAULT_COMMON_MAX_SPARES:I = 0x100

.field public static final DEFAULT_KEEPALIVE:J = 0xea60L

.field public static final DORMANT:I = -0x40000000

.field public static final FIFO:I = 0x10000

.field public static final MAX_CAP:I = 0x7fff

.field public static final MODE:J

.field public static final OWNED:I = 0x1

.field public static final POLL_LIMIT:I = 0x400

.field public static final QLOCK:I = 0x1

.field public static final QUIET:I = 0x40000000

.field public static final RC_MASK:J = -0x1000000000000L

.field public static final RC_SHIFT:I = 0x30

.field public static final RC_UNIT:J = 0x1000000000000L

.field public static final SEED_INCREMENT:I = -0x61c88647

.field public static final SHUTDOWN:I = 0x40000

.field public static final SMASK:I = 0xffff

.field public static final SP_MASK:J = 0xffffffffL

.field public static final SQMASK:I = 0x7e

.field public static final SS_SEQ:I = 0x10000

.field public static final STOP:I = -0x80000000

.field public static final SWIDTH:I = 0x10

.field public static final TC_MASK:J = 0xffff00000000L

.field public static final TC_SHIFT:I = 0x20

.field public static final TC_UNIT:J = 0x100000000L

.field public static final TERMINATED:I = 0x80000

.field public static final TIMEOUT_SLOP:J = 0x14L

.field public static final U:Lsun/misc/Unsafe;

.field public static final UC_MASK:J = -0x100000000L

.field public static final UNSIGNALLED:I = -0x80000000

.field public static final common:Ljava8/util/concurrent/ForkJoinPool;
...
.field public static final modifyThreadPermission:Ljava/lang/RuntimePermission;

.field public static poolNumberSequence:I


# instance fields
.field public final bounds:I

.field public volatile ctl:J

.field public final factory:Ljava8/util/concurrent/ForkJoinPool$ForkJoinWorkerThreadFactory;

.field public indexSeed:I

.field public final keepAlive:J
...
.field public volatile pad07:J

.field public volatile pad08:J

.field public volatile pad09:J

.field public volatile pad0a:J

.field public volatile pad0b:J

.field public volatile pad0c:J

.field public volatile pad0d:J

.field public volatile pad0e:J

.field public volatile pad0f:J

.field public volatile pad10:J

.field public volatile pad11:J

.field public volatile pad12:J

.field public volatile pad13:J

.field public volatile pad14:J

.field public volatile pad15:J

.field public volatile pad16:J

.field public volatile pad17:J

.field public volatile pad18:J

.field public volatile pad19:J

.field public volatile pad1a:J

.field public volatile pad1b:J

.field public volatile pad1c:J

.field public volatile pad1d:J

.field public volatile pad1e:J

.field public final saturate:Ljava8/util/function/Predicate;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field public workQueues:[Ljava8/util/concurrent/ForkJoinPool$WorkQueue;
...
.method public synthetic constructor <init>(BLjava8/util/concurrent/ForkJoinPool$1;)V
    .locals 0
...
.method public static commonSubmitterQueue()Ljava8/util/concurrent/ForkJoinPool$WorkQueue;
    .locals 3
...
.method public static varargs contextWithPermissions([Ljava/security/Permission;)Ljava/security/AccessControlContext;
    .locals 5
...
.method public static helpAsyncBlocker(Ljava/util/concurrent/Executor;Ljava8/util/concurrent/ForkJoinPool$ManagedBlocker;)V
    .locals 10
...
.method public static isInstanceOfAsynCompTask(Ljava8/util/concurrent/ForkJoinTask;)Z
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static newInstanceFromSystemProperty(Ljava/lang/String;)Ljava/lang/Object;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
...
.method public static final declared-synchronized nextPoolId()I
    .locals 2
...
# virtual methods
.method public final awaitJoin(Ljava8/util/concurrent/ForkJoinPool$WorkQueue;Ljava8/util/concurrent/ForkJoinTask;J)I
    .locals 21
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final deregisterWorker(Ljava8/util/concurrent/ForkJoinWorkerThread;Ljava/lang/Throwable;)V
    .locals 17
    ...
    iget-object v2, v9, Ljava8/util/concurrent/ForkJoinPool;->workerNamePrefix:Ljava/lang/String;

    iget v3, v0, Ljava8/util/concurrent/ForkJoinPool$WorkQueue;->nsteals:I

    int-to-long v3, v3

    and-long/2addr v3, v10

    iget v5, v0, Ljava8/util/concurrent/ForkJoinPool$WorkQueue;->id:I
    ...
    :try_start_0
    iget-object v6, v9, Ljava8/util/concurrent/ForkJoinPool;->workQueues:[Ljava8/util/concurrent/ForkJoinPool$WorkQueue;
    ...
    :cond_0
    iget-wide v5, v9, Ljava8/util/concurrent/ForkJoinPool;->stealCount:J

    add-long/2addr v5, v3

    iput-wide v5, v9, Ljava8/util/concurrent/ForkJoinPool;->stealCount:J
    ...
    :cond_1
    :goto_0
    iget v1, v0, Ljava8/util/concurrent/ForkJoinPool$WorkQueue;->phase:I
    ...
    iget-wide v5, v9, Ljava8/util/concurrent/ForkJoinPool;->ctl:J
    ...
    invoke-virtual {v0}, Ljava8/util/concurrent/ForkJoinPool$WorkQueue;->cancelAll()V

    :cond_6
    invoke-direct {v9, v12, v12}, Ljava8/util/concurrent/ForkJoinPool;->tryTerminate(ZZ)Z
...
.method public drainTasksTo(Ljava/util/Collection;)I
    ...
    :goto_1
    invoke-virtual {v3}, Ljava8/util/concurrent/ForkJoinPool$WorkQueue;->poll()Ljava8/util/concurrent/ForkJoinTask;
...
.method public final externalHelpComplete(Ljava8/util/concurrent/CountedCompleter;I)I
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iget-object v1, p0, Ljava8/util/concurrent/ForkJoinPool;->workQueues:[Ljava8/util/concurrent/ForkJoinPool$WorkQueue;
    ...
    invoke-virtual {v0, p1, p2}, Ljava8/util/concurrent/ForkJoinPool$WorkQueue;->sharedHelpCC(Ljava8/util/concurrent/CountedCompleter;I)I
...
.method public final externalPush(Ljava8/util/concurrent/ForkJoinTask;)V
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public getQueuedTaskCount()J
    ...
    invoke-virtual {v4}, Ljava8/util/concurrent/ForkJoinPool$WorkQueue;->queueSize()I
...
.method public getRunningThreadCount()I
    ...
    invoke-virtual {v3}, Ljava8/util/concurrent/ForkJoinPool$WorkQueue;->isApparentlyUnblocked()Z
...
.method public getStealCount()J
    ...
    iget v4, v4, Ljava8/util/concurrent/ForkJoinPool$WorkQueue;->nsteals:I
...
.method public getUncaughtExceptionHandler()Ljava/lang/Thread$UncaughtExceptionHandler;
    ...
    iget-object v0, p0, Ljava8/util/concurrent/ForkJoinPool;->ueh:Ljava/lang/Thread$UncaughtExceptionHandler;
...
.method public hasQueuedSubmissions()Z
    ...
    invoke-virtual {v3}, Ljava8/util/concurrent/ForkJoinPool$WorkQueue;->isEmpty()Z
...
.method public final helpComplete(Ljava8/util/concurrent/ForkJoinPool$WorkQueue;Ljava8/util/concurrent/CountedCompleter;I)I
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final helpQuiescePool(Ljava8/util/concurrent/ForkJoinPool$WorkQueue;)V
    .locals 25
...
.method public invokeAll(Ljava/util/Collection;)Ljava/util/List;
    ...
    check-cast v3, Ljava8/util/concurrent/ForkJoinTask;

    invoke-virtual {v3}, Ljava8/util/concurrent/ForkJoinTask;->quietlyJoin()V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final nextTaskFor(Ljava8/util/concurrent/ForkJoinPool$WorkQueue;)Ljava8/util/concurrent/ForkJoinTask;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public pollSubmission()Ljava8/util/concurrent/ForkJoinTask;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public final registerWorker(Ljava8/util/concurrent/ForkJoinWorkerThread;)Ljava8/util/concurrent/ForkJoinPool$WorkQueue;
    .locals 14
...
.method public final runWorker(Ljava8/util/concurrent/ForkJoinPool$WorkQueue;)V
    .locals 23
...
.method public final signalWork()V
    .locals 14
    ...
    iget v0, v8, Ljava8/util/concurrent/ForkJoinPool$WorkQueue;->source:I
...
.method public final tryExternalUnpush(Ljava8/util/concurrent/ForkJoinTask;)Z
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-virtual {v0, p1}, Ljava8/util/concurrent/ForkJoinPool$WorkQueue;->trySharedUnpush(Ljava8/util/concurrent/ForkJoinTask;)Z
