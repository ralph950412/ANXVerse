...
.method public final compute()V
    ...
    iget-object v12, v0, Ljava8/util/ArrayPrefixHelpers$DoubleCumulateTask;->array:[D

    if-eqz v12, :cond_1d

    iget v13, v0, Ljava8/util/ArrayPrefixHelpers$DoubleCumulateTask;->threshold:I

    iget v14, v0, Ljava8/util/ArrayPrefixHelpers$DoubleCumulateTask;->origin:I

    iget v15, v0, Ljava8/util/ArrayPrefixHelpers$DoubleCumulateTask;->fence:I

    move-object v9, v0

    :goto_0
    iget v8, v9, Ljava8/util/ArrayPrefixHelpers$DoubleCumulateTask;->lo:I

    if-ltz v8, :cond_1c

    iget v7, v9, Ljava8/util/ArrayPrefixHelpers$DoubleCumulateTask;->hi:I
    ...
    iget-object v1, v9, Ljava8/util/ArrayPrefixHelpers$DoubleCumulateTask;->left:Ljava8/util/ArrayPrefixHelpers$DoubleCumulateTask;

    iget-object v3, v9, Ljava8/util/ArrayPrefixHelpers$DoubleCumulateTask;->right:Ljava8/util/ArrayPrefixHelpers$DoubleCumulateTask;
    ...
    iput-object v11, v0, Ljava8/util/ArrayPrefixHelpers$DoubleCumulateTask;->right:Ljava8/util/ArrayPrefixHelpers$DoubleCumulateTask;
    ...
    iput-object v11, v0, Ljava8/util/ArrayPrefixHelpers$DoubleCumulateTask;->left:Ljava8/util/ArrayPrefixHelpers$DoubleCumulateTask;
    ...
    iget-wide v4, v0, Ljava8/util/ArrayPrefixHelpers$DoubleCumulateTask;->in:D
    ...
    :cond_f
    iget-wide v6, v0, Ljava8/util/ArrayPrefixHelpers$DoubleCumulateTask;->in:D
    ...
    invoke-interface {v10, v6, v7, v4, v5}, Ljava8/util/function/DoubleBinaryOperator;->applyAsDouble(DD)D
    ...
    :cond_12
    iput-wide v6, v0, Ljava8/util/ArrayPrefixHelpers$DoubleCumulateTask;->out:D
    ...
    check-cast v1, Ljava8/util/ArrayPrefixHelpers$DoubleCumulateTask;
    ...
    iget-object v6, v1, Ljava8/util/ArrayPrefixHelpers$DoubleCumulateTask;->left:Ljava8/util/ArrayPrefixHelpers$DoubleCumulateTask;

    if-eqz v6, :cond_17

    iget-object v7, v1, Ljava8/util/ArrayPrefixHelpers$DoubleCumulateTask;->right:Ljava8/util/ArrayPrefixHelpers$DoubleCumulateTask;

    if-eqz v7, :cond_17

    iget-wide v11, v6, Ljava8/util/ArrayPrefixHelpers$DoubleCumulateTask;->out:D

    iget v6, v7, Ljava8/util/ArrayPrefixHelpers$DoubleCumulateTask;->hi:I
    ...
    :cond_16
    iget-wide v6, v7, Ljava8/util/ArrayPrefixHelpers$DoubleCumulateTask;->out:D

    invoke-interface {v10, v11, v12, v6, v7}, Ljava8/util/function/DoubleBinaryOperator;->applyAsDouble(DD)D

    move-result-wide v11

    :goto_c
    iput-wide v11, v1, Ljava8/util/ArrayPrefixHelpers$DoubleCumulateTask;->out:D
    ...
    iget v6, v1, Ljava8/util/ArrayPrefixHelpers$DoubleCumulateTask;->lo:I
