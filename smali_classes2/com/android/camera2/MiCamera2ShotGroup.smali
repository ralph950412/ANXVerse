...
.method public notifyResultData([B)V
    ...
    const-string/jumbo v2, "notifyResultData: null parallel callback"
    ...
    invoke-interface {v2, v1, v3, v3}, Lcom/xiaomi/camera/core/ParallelCallback;->onParallelProcessFinish(Lcom/xiaomi/camera/core/ParallelTaskData;Landroid/hardware/camera2/CaptureResult;Landroid/hardware/camera2/CameraCharacteristics;)Z
    ...
    invoke-interface {v1, v3, v4, v5}, Lcom/android/camera2/Camera2Proxy$PictureCallback;->onPictureTakenFinished(ZJ)V
    ...
    const-string/jumbo v2, "notifyResultData: null picture callback"
