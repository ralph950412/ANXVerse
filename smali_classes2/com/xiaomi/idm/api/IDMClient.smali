...
# static fields
.field public static final TAG:Ljava/lang/String; = "IDMClient"


# instance fields
.field public mCalls:Ljava/util/concurrent/ConcurrentHashMap;
...
.field public mEvents:Ljava/util/concurrent/ConcurrentHashMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/concurrent/ConcurrentHashMap<",
            "Ljava/lang/String;",
...
.field public mIDMCallback:Lcom/xiaomi/idm/api/IDMClient$IDMClientCallback;

.field public mInnerCallback:Lcom/xiaomi/mi_connect_service/IIDMClientCallback;

.field public mNextRequestId:I

.field public mServiceFactory:Lcom/xiaomi/idm/api/IDMServiceFactoryBase;

.field public mServiceMap:Ljava/util/concurrent/ConcurrentHashMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/concurrent/ConcurrentHashMap<",
            "Ljava/lang/String;",
...
.method public static synthetic access$300(Lcom/xiaomi/idm/api/IDMClient;)Lcom/xiaomi/idm/api/IDMServiceFactoryBase;
    .locals 0
...
.method private doRequest(Lcom/xiaomi/idm/api/proto/IDMServiceProto$IDMRequest;)[B
    ...
    invoke-interface {v0, v2, p1}, Lcom/xiaomi/mi_connect_service/IMiConnect;->request(Ljava/lang/String;[B)[B
...
.method public abortInvitation(Ljava/lang/String;)V
    ...
    invoke-interface {v0, v1, p1}, Lcom/xiaomi/mi_connect_service/IMiConnect;->abortInvitation(Ljava/lang/String;[B)I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-static {v2, v0, p1}, Lcom/xiaomi/mi_connect_sdk/util/LogUtil;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public acceptConnection(Ljava/lang/String;)V
    ...
    invoke-interface {v0, v1, p1}, Lcom/xiaomi/mi_connect_service/IMiConnect;->clientAcceptConnection(Ljava/lang/String;[B)I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public disconnectService(Ljava/lang/String;I)V
    ...
    invoke-interface {p2, v0, p1}, Lcom/xiaomi/mi_connect_service/IMiConnect;->disconnectService(Ljava/lang/String;[B)I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-static {v2, p2, p1}, Lcom/xiaomi/mi_connect_sdk/util/LogUtil;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public doDestroy()V
    ...
    sget-object v3, Lcom/xiaomi/idm/api/ResponseCode$RequestCode;->ERR_CLIENT_DESTROYED:Lcom/xiaomi/idm/api/ResponseCode$RequestCode;
    ...
    const-string v2, "destroy called, but service unavailable"
...
.method public inviteConnection(Ljava/lang/String;)V
    ...
    invoke-interface {v0, v1, p1}, Lcom/xiaomi/mi_connect_service/IMiConnect;->inviteConnection(Ljava/lang/String;[B)I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public rejectConnection(Ljava/lang/String;)V
    ...
    invoke-interface {v0, v1, p1}, Lcom/xiaomi/mi_connect_service/IMiConnect;->clientRejectConnection(Ljava/lang/String;[B)I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public request(Lcom/xiaomi/idm/api/IDMService$Action;)Lcom/xiaomi/idm/task/CallFuture;
    ...
    iget-object p1, v3, Lcom/xiaomi/idm/api/IDMClient$Call;->future:Lcom/xiaomi/idm/task/CallFuture;
...
.method public setEventCallback(Lcom/xiaomi/idm/api/IDMService$Event;Z)I
    ...
    :cond_2
    iget-object p2, p0, Lcom/xiaomi/idm/api/IDMClient;->mEvents:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public startDiscovery(Lcom/xiaomi/idm/api/IDMClient$SDParamBuilder;)V
    ...
    invoke-interface {v0, v1, p1}, Lcom/xiaomi/mi_connect_service/IMiConnect;->startDiscoveryIDM(Ljava/lang/String;[B)I
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
