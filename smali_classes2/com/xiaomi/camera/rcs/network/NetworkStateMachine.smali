...
.method public getWhatToString(I)Ljava/lang/String;
    ...
    :pswitch_1
    const-string p1, "<service unbound>"
    ...
    :pswitch_4
    const-string p1, "<connection completed>"

    return-object p1

    :pswitch_5
    const-string p1, "<connection initiated>"
    ...
    :pswitch_7
    const-string p1, "<reject connection>"

    return-object p1

    :pswitch_8
    const-string p1, "<accept connection>"

    return-object p1

    :pswitch_9
    const-string p1, "<send payload>"

    return-object p1

    :pswitch_a
    const-string p1, "<start disconnecting>"

    return-object p1

    :pswitch_b
    const-string p1, "<start connecting>"

    return-object p1

    :pswitch_c
    const-string p1, "<start advertising>"

    return-object p1

    :pswitch_d
    const-string p1, "<start discovery>"
    ...
    :cond_2
    const-string p1, "<endpoint lost>"

    return-object p1

    :cond_3
    const-string p1, "<endpoint found>"

    return-object p1

    :cond_4
    const-string p1, "<advertising success>"

    return-object p1

    :cond_5
    const-string p1, "<advertising failure>"

    return-object p1

    :cond_6
    const-string p1, "<discovery success>"

    return-object p1

    :cond_7
    const-string p1, "<discovery failure>"
