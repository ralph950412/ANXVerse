...
# static fields
.field public static BACK_VT_CAMERA_ID_DEFAULT:Ljava/lang/String; = "100"

.field public static FRONT_VT_CAMERA_ID_DEFAULT:Ljava/lang/String; = "101"

.field public static final MAX_IMAGE_BUFFER_SIZE:I = 0x2

.field public static final TAG:Ljava/lang/String; = "VirtualCameraReprocessor"
...
# instance fields
.field public mBackVtCameraId:Ljava/lang/String;

.field public final mCameraLock:Ljava/lang/Object;

.field public mCameraManager:Landroid/hardware/camera2/CameraManager;

.field public mCameraOperationHandler:Landroid/os/Handler;

.field public mCameraOperationThread:Landroid/os/HandlerThread;

.field public volatile mCreatingReprocessSession:Z

.field public mCurrentProcessingData:Lcom/xiaomi/camera/imagecodec/ReprocessData;

.field public mCurrentSessionId:I

.field public final mDataLock:Ljava/lang/Object;

.field public mFrontVtCameraId:Ljava/lang/String;

.field public mInitialized:Z

.field public mInputConfiguration:Landroid/hardware/camera2/params/InputConfiguration;

.field public mNeedReopenCamera:Z

.field public mPicImageReader:Landroid/media/ImageReader;

.field public mPicOutputConfiguration:Lcom/xiaomi/camera/imagecodec/OutputConfiguration;

.field public mReprocessHandler:Landroid/os/Handler;

.field public mReprocessImageWriter:Landroid/media/ImageWriter;

.field public mReprocessStartTime:J

.field public mReprocessThread:Landroid/os/HandlerThread;

.field public mSessionFpsRange:Landroid/util/Range;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/util/Range<",
            "Ljava/lang/Integer;",
...
.field public mVTCameraDevice:Landroid/hardware/camera2/CameraDevice;

.field public mVTCaptureSession:Landroid/hardware/camera2/CameraCaptureSession;

.field public mWakeLock:Landroid/os/PowerManager$WakeLock;

.field public mYuvImageReader:Landroid/media/ImageReader;

.field public mYuvOutputConfiguration:Lcom/xiaomi/camera/imagecodec/OutputConfiguration;
...
.method public static synthetic access$1300(Lcom/xiaomi/camera/imagecodec/impl/VirtualCameraReprocessor;)Landroid/media/ImageWriter;
    .locals 0
...
.method public static synthetic access$1302(Lcom/xiaomi/camera/imagecodec/impl/VirtualCameraReprocessor;Landroid/media/ImageWriter;)Landroid/media/ImageWriter;
    .locals 0
...
.method public static synthetic access$1400(Lcom/xiaomi/camera/imagecodec/impl/VirtualCameraReprocessor;)J
    .locals 2
...
.method public static synthetic access$1500(Lcom/xiaomi/camera/imagecodec/impl/VirtualCameraReprocessor;)Z
    .locals 0
...
.method public static synthetic access$1600(Lcom/xiaomi/camera/imagecodec/impl/VirtualCameraReprocessor;)V
    .locals 0
...
.method private createReprocessSession(Landroid/hardware/camera2/params/InputConfiguration;Lcom/xiaomi/camera/imagecodec/OutputConfiguration;Lcom/xiaomi/camera/imagecodec/OutputConfiguration;Lcom/xiaomi/camera/imagecodec/ReprocessData;)V
    ...
    invoke-direct {p0, v0, v2}, Lcom/xiaomi/camera/imagecodec/impl/VirtualCameraReprocessor;->initYuvImageReader(II)V
    ...
    invoke-direct {p0, v0, v2, v3}, Lcom/xiaomi/camera/imagecodec/impl/VirtualCameraReprocessor;->initPicImageReader(III)V
    ...
    iget-object v2, v1, Lcom/xiaomi/camera/imagecodec/impl/VirtualCameraReprocessor;->mPicImageReader:Landroid/media/ImageReader;
    ...
    iget-object v2, v1, Lcom/xiaomi/camera/imagecodec/impl/VirtualCameraReprocessor;->mYuvImageReader:Landroid/media/ImageReader;
    ...
    invoke-static {v0, v5}, Lcom/xiaomi/protocol/ICustomCaptureResult;->toTotalCaptureResult(Lcom/xiaomi/protocol/ICustomCaptureResult;I)Landroid/hardware/camera2/TotalCaptureResult;
    ...
    iget-object v0, v1, Lcom/xiaomi/camera/imagecodec/impl/VirtualCameraReprocessor;->mVTCameraDevice:Landroid/hardware/camera2/CameraDevice;
    ...
    iget-object v2, v1, Lcom/xiaomi/camera/imagecodec/impl/VirtualCameraReprocessor;->mVTCameraDevice:Landroid/hardware/camera2/CameraDevice;
    ...
    invoke-virtual {v11, v0}, Landroid/hardware/camera2/CaptureRequest;->get(Landroid/hardware/camera2/CaptureRequest$Key;)Ljava/lang/Object;
    ...
    iput-object v0, v1, Lcom/xiaomi/camera/imagecodec/impl/VirtualCameraReprocessor;->mSessionFpsRange:Landroid/util/Range;

    :cond_3
    iget-object v8, v1, Lcom/xiaomi/camera/imagecodec/impl/VirtualCameraReprocessor;->mVTCameraDevice:Landroid/hardware/camera2/CameraDevice;

    iget-object v13, v1, Lcom/xiaomi/camera/imagecodec/impl/VirtualCameraReprocessor;->mCameraOperationHandler:Landroid/os/Handler;
    ...
    iget-object v3, v1, Lcom/xiaomi/camera/imagecodec/impl/VirtualCameraReprocessor;->mCameraOperationHandler:Landroid/os/Handler;

    invoke-virtual {v2, v9, v0, v12, v3}, Landroid/hardware/camera2/CameraDevice;->createReprocessableCaptureSession(Landroid/hardware/camera2/params/InputConfiguration;Ljava/util/List;Landroid/hardware/camera2/CameraCaptureSession$StateCallback;Landroid/os/Handler;)V
    :try_end_0
    ...
    const-string v2, "createReprocessSession<<"
...
.method public static getSessionId(Landroid/hardware/camera2/CameraCaptureSession;)I
    .locals 2
...
.method private initPicImageReader(III)V
    ...
    iget-object p3, p0, Lcom/xiaomi/camera/imagecodec/impl/VirtualCameraReprocessor;->mCameraOperationHandler:Landroid/os/Handler;
    ...
    const-string p2, "initPicImageReader<<"
...
.method private initYuvImageReader(II)V
    ...
    iget-object v0, p0, Lcom/xiaomi/camera/imagecodec/impl/VirtualCameraReprocessor;->mCameraOperationHandler:Landroid/os/Handler;
...
.method private openVTCamera(Ljava/lang/String;)V
    ...
    iget-object v2, p0, Lcom/xiaomi/camera/imagecodec/impl/VirtualCameraReprocessor;->mCameraOperationHandler:Landroid/os/Handler;
...
.method private reprocessImage()V
    ...
    invoke-virtual {v8}, Lcom/xiaomi/camera/imagecodec/ReprocessData;->getSiqeType()B
    ...
    iput-wide v9, p0, Lcom/xiaomi/camera/imagecodec/impl/VirtualCameraReprocessor;->mReprocessStartTime:J

    iget-object v9, p0, Lcom/xiaomi/camera/imagecodec/impl/VirtualCameraReprocessor;->mCameraLock:Ljava/lang/Object;
    ...
    invoke-virtual {v0, v10, v11}, Landroid/hardware/camera2/CaptureRequest$Builder;->set(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)V
    ...
    iget-object v10, p0, Lcom/xiaomi/camera/imagecodec/impl/VirtualCameraReprocessor;->mPicImageReader:Landroid/media/ImageReader;
    ...
    invoke-virtual {v0, v10, v2}, Landroid/hardware/camera2/CaptureRequest$Builder;->set(Landroid/hardware/camera2/CaptureRequest$Key;Ljava/lang/Object;)V
    ...
    sget-object v1, Lcom/xiaomi/camera/imagecodec/CaptureRequestVendorTags;->XIAOMI_SIQE_TYPE:Lcom/xiaomi/camera/imagecodec/VendorTag;

    invoke-static {v8}, Ljava/lang/Byte;->valueOf(B)Ljava/lang/Byte;

    move-result-object v2

    invoke-static {v0, v1, v2}, Lcom/xiaomi/camera/imagecodec/CaptureRequestVendorTags;->setValueSafely(Landroid/hardware/camera2/CaptureRequest$Builder;Lcom/xiaomi/camera/imagecodec/VendorTag;Ljava/lang/Object;)V
    ...
    iget-object v3, p0, Lcom/xiaomi/camera/imagecodec/impl/VirtualCameraReprocessor;->mCameraOperationHandler:Landroid/os/Handler;
