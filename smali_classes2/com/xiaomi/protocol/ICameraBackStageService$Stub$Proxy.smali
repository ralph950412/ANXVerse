.class public Lcom/xiaomi/protocol/ICameraBackStageService$Stub$Proxy;
...
# static fields
.field public static sDefaultImpl:Lcom/xiaomi/protocol/ICameraBackStageService;
...
.method public addCapturePath(Ljava/lang/String;)V
    ...
    invoke-static {}, Lcom/xiaomi/protocol/ICameraBackStageService$Stub;->getDefaultImpl()Lcom/xiaomi/protocol/ICameraBackStageService;
    ...
    invoke-interface {v2, p1}, Lcom/xiaomi/protocol/ICameraBackStageService;->addCapturePath(Ljava/lang/String;)V
    :try_end_0
...
.method public configCaptureOutputBuffer(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-interface {v2, p1}, Lcom/xiaomi/protocol/ICameraBackStageService;->configCaptureOutputBuffer(Ljava/util/List;)Ljava/util/List;
...
.method public configCaptureSession(Lcom/xiaomi/engine/BufferFormat;)V
    ...
    :goto_0
    iget-object v3, p0, Lcom/xiaomi/protocol/ICameraBackStageService$Stub$Proxy;->mRemote:Landroid/os/IBinder;
    ...
    invoke-interface {v2, p1}, Lcom/xiaomi/protocol/ICameraBackStageService;->configCaptureSession(Lcom/xiaomi/engine/BufferFormat;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public needWaitProcess()Z
    ...
    invoke-interface {v2}, Lcom/xiaomi/protocol/ICameraBackStageService;->needWaitProcess()Z
...
.method public onCaptureCompleted(Ljava/util/List;Ljava/lang/String;)V
    ...
    invoke-interface {v2, p1, p2}, Lcom/xiaomi/protocol/ICameraBackStageService;->onCaptureCompleted(Ljava/util/List;Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public onCaptureFailed(Ljava/lang/String;I)V
    ...
    invoke-interface {v2, p1, p2}, Lcom/xiaomi/protocol/ICameraBackStageService;->onCaptureFailed(Ljava/lang/String;I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
