.class public final Ljava8/util/stream/WhileOps$1;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Ljava8/util/stream/WhileOps;->makeTakeWhileRef(Ljava8/util/stream/AbstractPipeline;Ljava8/util/function/Predicate;)Ljava8/util/stream/Stream;
.end annotation
...
.method public constructor <init>(Ljava8/util/stream/AbstractPipeline;Ljava8/util/stream/StreamShape;ILjava8/util/function/Predicate;)V
    ...
    iput-object p4, p0, Ljava8/util/stream/WhileOps$1;->val$predicate:Ljava8/util/function/Predicate;
...
.method public opEvaluateParallelLazy(Ljava8/util/stream/PipelineHelper;Ljava8/util/Spliterator;)Ljava8/util/Spliterator;
    ...
    invoke-virtual {p0, p1, p2, v0}, Ljava8/util/stream/WhileOps$1;->opEvaluateParallel(Ljava8/util/stream/PipelineHelper;Ljava8/util/Spliterator;Ljava8/util/function/IntFunction;)Ljava8/util/stream/Node;
    ...
    iget-object v1, p0, Ljava8/util/stream/WhileOps$1;->val$predicate:Ljava8/util/function/Predicate;

    invoke-direct {v0, p1, p2, v1}, Ljava8/util/stream/WhileOps$UnorderedWhileSpliterator$OfRef$Taking;-><init>(Ljava8/util/Spliterator;ZLjava8/util/function/Predicate;)V
...
.method public opWrapSink(ILjava8/util/stream/Sink;)Ljava8/util/stream/Sink;
    ...
    new-instance p1, Ljava8/util/stream/WhileOps$1$1;

    invoke-direct {p1, p0, p2}, Ljava8/util/stream/WhileOps$1$1;-><init>(Ljava8/util/stream/WhileOps$1;Ljava8/util/stream/Sink;)V
