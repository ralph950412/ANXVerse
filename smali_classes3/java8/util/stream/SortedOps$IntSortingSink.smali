.class public final Ljava8/util/stream/SortedOps$IntSortingSink;
...
# instance fields
.field public b:Ljava8/util/stream/SpinedBuffer$OfInt;
...
.method public accept(I)V
    ...
    iget-object v0, p0, Ljava8/util/stream/SortedOps$IntSortingSink;->b:Ljava8/util/stream/SpinedBuffer$OfInt;
...
.method public begin(J)V
    ...
    invoke-direct {v0, p1}, Ljava8/util/stream/SpinedBuffer$OfInt;-><init>(I)V
    ...
    :goto_0
    iput-object v0, p0, Ljava8/util/stream/SortedOps$IntSortingSink;->b:Ljava8/util/stream/SpinedBuffer$OfInt;
...
.method public end()V
    ...
    iget-boolean v1, p0, Ljava8/util/stream/SortedOps$AbstractIntSortingSink;->cancellationRequestedCalled:Z
    ...
    iget-object v4, p0, Ljava8/util/stream/Sink$ChainedInt;->downstream:Ljava8/util/stream/Sink;

    invoke-interface {v4, v3}, Ljava8/util/stream/Sink;->accept(I)V
    ...
    invoke-interface {v4}, Ljava8/util/stream/Sink;->cancellationRequested()Z
