.class public final Ljava8/util/stream/SliceOps$3;
...
.method public opEvaluateParallel(Ljava8/util/stream/PipelineHelper;Ljava8/util/Spliterator;Ljava8/util/function/IntFunction;)Ljava8/util/stream/Node;
    ...
    iget-wide v12, v9, Ljava8/util/stream/SliceOps$3;->val$skip:J

    iget-wide v14, v9, Ljava8/util/stream/SliceOps$3;->val$limit:J
    ...
    invoke-static {v2, v0, v8}, Ljava8/util/stream/Nodes;->collectLong(Ljava8/util/stream/PipelineHelper;Ljava8/util/Spliterator;Z)Ljava8/util/stream/Node$OfLong;
    ...
    iget-wide v2, v9, Ljava8/util/stream/SliceOps$3;->val$skip:J

    iget-wide v4, v9, Ljava8/util/stream/SliceOps$3;->val$limit:J
    ...
    invoke-static {v9, v0, v8}, Ljava8/util/stream/Nodes;->collectLong(Ljava8/util/stream/PipelineHelper;Ljava8/util/Spliterator;Z)Ljava8/util/stream/Node$OfLong;
    ...
    iget-wide v5, v9, Ljava8/util/stream/SliceOps$3;->val$skip:J

    iget-wide v7, v9, Ljava8/util/stream/SliceOps$3;->val$limit:J
...
.method public opEvaluateParallelLazy(Ljava8/util/stream/PipelineHelper;Ljava8/util/Spliterator;)Ljava8/util/Spliterator;
    ...
    check-cast v11, Ljava8/util/Spliterator$OfLong;

    iget-wide v12, v9, Ljava8/util/stream/SliceOps$3;->val$skip:J

    iget-wide v1, v9, Ljava8/util/stream/SliceOps$3;->val$limit:J
    ...
    invoke-direct/range {v10 .. v15}, Ljava8/util/stream/StreamSpliterators$SliceSpliterator$OfLong;-><init>(Ljava8/util/Spliterator$OfLong;JJ)V
...
.method public unorderedSkipLimitSpliterator(Ljava8/util/Spliterator$OfLong;JJJ)Ljava8/util/Spliterator$OfLong;
    .locals 7
    ...
    :goto_0
    new-instance v2, Ljava8/util/stream/StreamSpliterators$UnorderedSliceSpliterator$OfLong;
    ...
    invoke-direct/range {p2 .. p7}, Ljava8/util/stream/StreamSpliterators$UnorderedSliceSpliterator$OfLong;-><init>(Ljava8/util/Spliterator$OfLong;JJ)V
