.class public final Ljava8/util/stream/Nodes;
...
# static fields
.field public static final BAD_SIZE:Ljava/lang/String; = "Stream size exceeds max array size"

.field public static final EMPTY_DOUBLE_ARRAY:[D

.field public static final EMPTY_DOUBLE_NODE:Ljava8/util/stream/Node$OfDouble;

.field public static final EMPTY_INT_ARRAY:[I

.field public static final EMPTY_INT_NODE:Ljava8/util/stream/Node$OfInt;

.field public static final EMPTY_LONG_ARRAY:[J

.field public static final EMPTY_LONG_NODE:Ljava8/util/stream/Node$OfLong;

.field public static final EMPTY_NODE:Ljava8/util/stream/Node;
...
.method public static builder()Ljava8/util/stream/Node$Builder;
    .locals 1
...
.method public static builder(JLjava8/util/function/IntFunction;)Ljava8/util/stream/Node$Builder;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static castingArray()Ljava8/util/function/IntFunction;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static conc(Ljava8/util/stream/StreamShape;Ljava8/util/stream/Node;Ljava8/util/stream/Node;)Ljava8/util/stream/Node;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static doubleBuilder(J)Ljava8/util/stream/Node$Builder$OfDouble;
    .locals 2
...
.method public static emptyNode(Ljava8/util/stream/StreamShape;)Ljava8/util/stream/Node;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static getChild()Ljava8/util/stream/Node;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static intBuilder(J)Ljava8/util/stream/Node$Builder$OfInt;
    .locals 2
...
.method public static synthetic lambda$truncate$104(Ljava/lang/Object;)V
    .locals 0
...
.method public static longBuilder(J)Ljava8/util/stream/Node$Builder$OfLong;
    .locals 2
...
.method public static node(Ljava/util/Collection;)Ljava8/util/stream/Node;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static node([Ljava/lang/Object;)Ljava8/util/stream/Node;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static truncate(Ljava8/util/stream/Node;JJLjava8/util/function/IntFunction;)Ljava8/util/stream/Node;
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
