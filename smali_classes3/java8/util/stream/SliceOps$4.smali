.class public final Ljava8/util/stream/SliceOps$4;
...
.annotation system Ldalvik/annotation/EnclosingMethod;
    value = Ljava8/util/stream/SliceOps;->makeDouble(Ljava8/util/stream/AbstractPipeline;JJ)Ljava8/util/stream/DoubleStream;
.end annotation
...
.method public constructor <init>(Ljava8/util/stream/AbstractPipeline;Ljava8/util/stream/StreamShape;IJJ)V
    ...
    iput-wide p4, p0, Ljava8/util/stream/SliceOps$4;->val$skip:J

    iput-wide p6, p0, Ljava8/util/stream/SliceOps$4;->val$limit:J
...
.method public opEvaluateParallel(Ljava8/util/stream/PipelineHelper;Ljava8/util/Spliterator;Ljava8/util/function/IntFunction;)Ljava8/util/stream/Node;
    ...
    iget-wide v12, v9, Ljava8/util/stream/SliceOps$4;->val$skip:J

    iget-wide v14, v9, Ljava8/util/stream/SliceOps$4;->val$limit:J
    ...
    invoke-static {v2, v0, v8}, Ljava8/util/stream/Nodes;->collectDouble(Ljava8/util/stream/PipelineHelper;Ljava8/util/Spliterator;Z)Ljava8/util/stream/Node$OfDouble;
    ...
    iget-wide v2, v9, Ljava8/util/stream/SliceOps$4;->val$skip:J

    iget-wide v4, v9, Ljava8/util/stream/SliceOps$4;->val$limit:J

    move-object/from16 v0, p0

    invoke-virtual/range {v0 .. v7}, Ljava8/util/stream/SliceOps$4;->unorderedSkipLimitSpliterator(Ljava8/util/Spliterator$OfDouble;JJJ)Ljava8/util/Spliterator$OfDouble;

    move-result-object v0

    invoke-static {v9, v0, v8}, Ljava8/util/stream/Nodes;->collectDouble(Ljava8/util/stream/PipelineHelper;Ljava8/util/Spliterator;Z)Ljava8/util/stream/Node$OfDouble;
    ...
    iget-wide v5, v9, Ljava8/util/stream/SliceOps$4;->val$skip:J

    iget-wide v7, v9, Ljava8/util/stream/SliceOps$4;->val$limit:J
...
.method public opEvaluateParallelLazy(Ljava8/util/stream/PipelineHelper;Ljava8/util/Spliterator;)Ljava8/util/Spliterator;
    ...
    check-cast v11, Ljava8/util/Spliterator$OfDouble;

    iget-wide v12, v9, Ljava8/util/stream/SliceOps$4;->val$skip:J

    iget-wide v1, v9, Ljava8/util/stream/SliceOps$4;->val$limit:J
    ...
    invoke-direct/range {v10 .. v15}, Ljava8/util/stream/StreamSpliterators$SliceSpliterator$OfDouble;-><init>(Ljava8/util/Spliterator$OfDouble;JJ)V
    ...
    sget-object v4, Ljava8/util/stream/WhileOps;->DOUBLE_ARR_GEN:Ljava8/util/function/IntFunction;
...
.method public opWrapSink(ILjava8/util/stream/Sink;)Ljava8/util/stream/Sink;
    ...
    new-instance p1, Ljava8/util/stream/SliceOps$4$1;

    invoke-direct {p1, p0, p2}, Ljava8/util/stream/SliceOps$4$1;-><init>(Ljava8/util/stream/SliceOps$4;Ljava8/util/stream/Sink;)V

    return-object p1
.end method

.method public unorderedSkipLimitSpliterator(Ljava8/util/Spliterator$OfDouble;JJJ)Ljava8/util/Spliterator$OfDouble;
    .locals 7
    ...
    :goto_0
    new-instance v2, Ljava8/util/stream/StreamSpliterators$UnorderedSliceSpliterator$OfDouble;
    ...
    invoke-direct/range {p2 .. p7}, Ljava8/util/stream/StreamSpliterators$UnorderedSliceSpliterator$OfDouble;-><init>(Ljava8/util/Spliterator$OfDouble;JJ)V
