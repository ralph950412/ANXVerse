...
.field public static final PREF_PREFIX:Ljava/lang/String; = "libstreaming-"

.field public static final TAG:Ljava/lang/String; = "MediaStream"

.field public static final sPipeApi:B

.field public static sSuggestedMode:B = 0x5t
...
.field public mLss:Landroid/net/LocalServerSocket;
...
.field public mParcelFileDescriptors:[Landroid/os/ParcelFileDescriptor;

.field public mParcelRead:Landroid/os/ParcelFileDescriptor;

.field public mParcelWrite:Landroid/os/ParcelFileDescriptor;

.field public mReceiver:Landroid/net/LocalSocket;

.field public mRequestedMode:B

.field public mRtcpPort:I

.field public mRtpPort:I

.field public mSender:Landroid/net/LocalSocket;

.field public mSocketId:I
...
.method public abstract encodeWithMediaCodec()V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
...
.method public abstract encodeWithMediaRecorder()V
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
...
.method public getBitrate()J
    ...
    invoke-virtual {v0}, Lnet/majorkernelpanic/streaming/rtp/RtpSocket;->getBitrate()J
...
.method public getDestinationPorts()[I
    ...
    iget v1, p0, Lnet/majorkernelpanic/streaming/MediaStream;->mRtcpPort:I
...
.method public getLocalPorts()[I
    ...
    invoke-virtual {v0}, Lnet/majorkernelpanic/streaming/rtp/RtpSocket;->getLocalPorts()[I
...
.method public getSSRC()I
    ...
    invoke-virtual {v0}, Lnet/majorkernelpanic/streaming/rtp/AbstractPacketizer;->getSSRC()I
