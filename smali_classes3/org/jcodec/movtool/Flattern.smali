...
.method private calcProgress(III)I
    ...
    invoke-interface {p3, p2}, Lorg/jcodec/movtool/Flattern$ProgressListener;->trigger(I)V
...
.method private writeHeader(Lorg/jcodec/containers/mp4/boxes/Header;Lorg/jcodec/common/io/SeekableByteChannel;)V
    ...
    invoke-interface {p2, v0}, Ljava/nio/channels/ByteChannel;->write(Ljava/nio/ByteBuffer;)I
