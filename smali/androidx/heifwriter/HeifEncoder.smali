...
.field public static final GRID_HEIGHT:I = 0x200

.field public static final GRID_WIDTH:I = 0x200

.field public static final INPUT_BUFFER_POOL_SIZE:I = 0x2
...
.field public static final MAX_COMPRESS_RATIO:D = 0.25

.field public static final TAG:Ljava/lang/String; = "HeifEncoder"
...
.field public mCurrentBuffer:Ljava/nio/ByteBuffer;
...
.field public final mEmptyBuffers:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList<",
...
.field public mEncoderEglSurface:Landroidx/heifwriter/EglWindowSurface;

.field public mEncoderSurface:Landroid/view/Surface;

.field public final mFilledBuffers:Ljava/util/ArrayList;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/ArrayList<",
            "Ljava/nio/ByteBuffer;",
...
.field public mInputTexture:Landroid/graphics/SurfaceTexture;

.field public final mNumTiles:I

.field public mRectBlt:Landroidx/heifwriter/EglRectBlt;
...
.method public constructor <init>(IIZIILandroid/os/Handler;Landroidx/heifwriter/HeifEncoder$Callback;)V
    ...
    :goto_f
    new-instance v2, Landroidx/heifwriter/HeifEncoder$SurfaceEOSTracker;

    invoke-direct {v2, v0, v5}, Landroidx/heifwriter/HeifEncoder$SurfaceEOSTracker;-><init>(Landroidx/heifwriter/HeifEncoder;Z)V

    iput-object v2, v0, Landroidx/heifwriter/HeifEncoder;->mEOSTracker:Landroidx/heifwriter/HeifEncoder$SurfaceEOSTracker;
    ...
    :goto_10
    invoke-direct {v3, v5}, Landroidx/heifwriter/Texture2dProgram;-><init>(I)V
...
.method public static copyOneTileYUV(Ljava/nio/ByteBuffer;Landroid/media/Image;IILandroid/graphics/Rect;Landroid/graphics/Rect;)V
    .locals 17
