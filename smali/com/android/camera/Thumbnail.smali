...
.method public constructor <init>(Landroid/net/Uri;Landroid/graphics/Bitmap;IZZ)V
    .locals 1
...
.method public static adjustImage(Landroid/graphics/Bitmap;IZZ)Landroid/graphics/Bitmap;
    .locals 9
...
.method public static createThumbnailFromUri(Landroid/content/Context;Landroid/net/Uri;Z)Lcom/android/camera/Thumbnail;
    ...
    invoke-static {v10, v11, v12, v4, v8}, Landroid/provider/MediaStore$Images$Thumbnails;->getThumbnail(Landroid/content/ContentResolver;JILandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v6, v5, v3, v2}, Lcom/android/camera/Thumbnail;->getScaledBitmapFromFile(Ljava/lang/String;III)Landroid/graphics/Bitmap;
    ...
    invoke-static {v6, v5, v3}, Lcom/android/camera/Thumbnail;->createVideoThumbnailBitmap(Ljava/lang/String;II)Landroid/graphics/Bitmap;
    ...
    :goto_7
    invoke-static {v0, v8, v5, v1}, Lcom/android/camera/Thumbnail;->createThumbnail(Landroid/net/Uri;Landroid/graphics/Bitmap;IZ)Lcom/android/camera/Thumbnail;
...
.method public static getImageBucketIds()Ljava/lang/String;
    .locals 2
...
.method public static getLastThumbnailFromContentResolver(Landroid/content/Context;[Lcom/android/camera/Thumbnail;Landroid/net/Uri;)I
    ...
    invoke-static {v7}, Lcom/android/camera/Thumbnail;->getLastImageThumbnail(Landroid/content/ContentResolver;)Lcom/android/camera/Thumbnail$Media;

    move-result-object v8

    invoke-static {v7}, Lcom/android/camera/Thumbnail;->getLastVideoThumbnail(Landroid/content/ContentResolver;)Lcom/android/camera/Thumbnail$Media;
    ...
    iget-wide v4, v8, Lcom/android/camera/Thumbnail$Media;->dateTaken:J

    iget-wide v14, v9, Lcom/android/camera/Thumbnail$Media;->dateTaken:J
    ...
    iget-object v4, v8, Lcom/android/camera/Thumbnail$Media;->uri:Landroid/net/Uri;
    ...
    iget-object v1, v8, Lcom/android/camera/Thumbnail$Media;->uri:Landroid/net/Uri;
    ...
    :cond_2
    iget-object v14, v8, Lcom/android/camera/Thumbnail$Media;->path:Ljava/lang/String;
    ...
    iget-wide v2, v8, Lcom/android/camera/Thumbnail$Media;->id:J

    iget v4, v8, Lcom/android/camera/Thumbnail$Media;->orientation:I
    ...
    :cond_3
    iget-wide v0, v8, Lcom/android/camera/Thumbnail$Media;->id:J

    invoke-static {v7, v0, v1, v13, v3}, Landroid/provider/MediaStore$Images$Thumbnails;->getThumbnail(Landroid/content/ContentResolver;JILandroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    ...
    invoke-static {v10, v0, v2}, Lcom/android/camera/log/Log;->e(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)I
    ...
    iget v0, v8, Lcom/android/camera/Thumbnail$Media;->width:I

    iget v1, v8, Lcom/android/camera/Thumbnail$Media;->height:I

    iget v2, v8, Lcom/android/camera/Thumbnail$Media;->orientation:I
    ...
    iget-object v4, v9, Lcom/android/camera/Thumbnail$Media;->uri:Landroid/net/Uri;
    ...
    iget-object v1, v9, Lcom/android/camera/Thumbnail$Media;->uri:Landroid/net/Uri;
    ...
    invoke-static {v0, v1, v11}, Lcom/android/camera/Thumbnail;->createThumbnailFromUri(Landroid/content/Context;Landroid/net/Uri;Z)Lcom/android/camera/Thumbnail;

    move-result-object v0

    if-eqz v0, :cond_7

    iget-object v3, v0, Lcom/android/camera/Thumbnail;->mBitmap:Landroid/graphics/Bitmap;
    ...
    :cond_8
    :goto_2
    iget-object v0, v8, Lcom/android/camera/Thumbnail$Media;->uri:Landroid/net/Uri;
    ...
    :cond_9
    iget v0, v8, Lcom/android/camera/Thumbnail$Media;->orientation:I
    ...
    iget-wide v4, v9, Lcom/android/camera/Thumbnail$Media;->id:J

    cmp-long v2, v2, v4

    if-nez v2, :cond_a

    iget-object v2, v8, Lcom/android/camera/Thumbnail$Media;->path:Ljava/lang/String;

    invoke-static {v2}, Lcom/android/camera/Util;->isHDR10Video(Ljava/lang/String;)Z
    ...
    :goto_4
    iget-object v3, v8, Lcom/android/camera/Thumbnail$Media;->uri:Landroid/net/Uri;

    invoke-static {v3, v1, v0, v11, v2}, Lcom/android/camera/Thumbnail;->createThumbnail(Landroid/net/Uri;Landroid/graphics/Bitmap;IZZ)Lcom/android/camera/Thumbnail;
    ...
    iget-boolean v0, v8, Lcom/android/camera/Thumbnail$Media;->isGif:Z
    ...
    iget v1, v8, Lcom/android/camera/Thumbnail$Media;->width:I

    iget v2, v8, Lcom/android/camera/Thumbnail$Media;->height:I
...
.method public static getLastThumbnailUri(Landroid/content/ContentResolver;)Landroid/net/Uri;
    ...
    :cond_3
    const-string p0, "getLastThumbnailUri: uri = null"
...
.method public static getLastVideoThumbnail(Landroid/content/ContentResolver;)Lcom/android/camera/Thumbnail$Media;
    .locals 26
...
.method public static getVideoBucketIds()Ljava/lang/String;
    .locals 2
...
.method public saveLastThumbnailToFile(Ljava/io/File;)V
    ...
    const-string/jumbo v5, "saveLastThumbnailToFile: version: 1"
