...
.method public moveToEdge()V
    ...
    const-string/jumbo v7, "xSpeed_tag"
    ...
    invoke-virtual {v0, v9, v7}, Lmiuix/animation/base/AnimConfig;->setEase(I[F)Lmiuix/animation/base/AnimConfig;

    move-result-object v0

    new-array v7, v3, [Lmiuix/animation/listener/TransitionListener;

    new-instance v10, Lcom/android/camera/dualvideo/render/RegionHelper$1;

    invoke-direct {v10, p0}, Lcom/android/camera/dualvideo/render/RegionHelper$1;-><init>(Lcom/android/camera/dualvideo/render/RegionHelper;)V
    ...
    const-string/jumbo v7, "ySpeed_tag"
    ...
    invoke-virtual {v2, v9, v6}, Lmiuix/animation/base/AnimConfig;->setEase(I[F)Lmiuix/animation/base/AnimConfig;

    move-result-object v2

    new-array v3, v3, [Lmiuix/animation/listener/TransitionListener;

    new-instance v6, Lcom/android/camera/dualvideo/render/RegionHelper$2;

    invoke-direct {v6, p0}, Lcom/android/camera/dualvideo/render/RegionHelper$2;-><init>(Lcom/android/camera/dualvideo/render/RegionHelper;)V
...
.method public declared-synchronized updateMarginOffset(II)V
    ...
    const-string/jumbo v1, "xSpeed_tag"
