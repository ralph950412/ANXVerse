...
.field public static final TAG:Ljava/lang/String; = "MP4UtilEx"
...
.method public static addBox(Lorg/jcodec/containers/mp4/boxes/MovieBox;Ljava/lang/String;[B)V
    .locals 2
...
.method public static getCover(Landroid/os/ParcelFileDescriptor;Ljava/lang/String;Lcom/android/camera/CameraSize;[Landroid/graphics/Bitmap;)Z
    .locals 3

    invoke-static {p1}, Lcom/android/camera/jcodec/MP4UtilEx;->readCover(Ljava/lang/String;)Landroid/graphics/Bitmap;
    ...
    iget v2, p2, Lcom/android/camera/CameraSize;->height:I
    ...
    invoke-direct {p2, v0, v2}, Lcom/android/camera/CameraSize;-><init>(II)V
    ...
    invoke-static {p0, p1, p2}, Lcom/android/camera/Thumbnail;->createVideoThumbnailBitmap(Ljava/io/FileDescriptor;II)Landroid/graphics/Bitmap;
    ...
    :cond_1
    iget p0, p2, Lcom/android/camera/CameraSize;->width:I

    iget p2, p2, Lcom/android/camera/CameraSize;->height:I

    invoke-static {p1, p0, p2}, Lcom/android/camera/Thumbnail;->createVideoThumbnailBitmap(Ljava/lang/String;II)Landroid/graphics/Bitmap;
...
.method public static readCover(Ljava/lang/String;)Landroid/graphics/Bitmap;
    ...
    const-string/jumbo v1, "readCover E"
    ...
    const-string/jumbo v4, "readCover X , duration = "
