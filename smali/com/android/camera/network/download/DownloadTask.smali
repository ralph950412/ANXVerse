.class public Lcom/android/camera/network/download/DownloadTask;
...
# instance fields
.field public mCoreTask:Lcom/android/camera/network/download/DownloadTask$CoreTask;

.field public mOnCompleteListener:Lcom/android/camera/network/download/DownloadTask$OnCompleteListener;

.field public mOnProgressListener:Lcom/android/camera/network/download/DownloadTask$OnProgressListener;

.field public mTaskInfo:Lcom/android/camera/network/download/DownloadTask$TaskInfo;
...
.method private performRequest(Lcom/android/camera/network/download/Request;)I
    ...
    const-string/jumbo v1, "start to download request[%s, %s, %s]"
    ...
    const-string/jumbo v7, "retry for %d"
...
.method private postDownload()I
    ...
    iget-object v3, v3, Lcom/android/camera/network/download/DownloadTask$TaskInfo;->mDigest:Ljava/security/MessageDigest;

    invoke-virtual {v3}, Ljava/security/MessageDigest;->digest()[B

    move-result-object v3

    invoke-virtual {v0, v3}, Lcom/android/camera/network/download/Verifier;->verify([B)Z
...
.method private process(Lcom/android/camera/network/download/Request;)I
    ...
    const-string/jumbo p1, "response code not valid"
    ...
    const-string/jumbo p1, "open output stream failed"
    ...
    const-string/jumbo p1, "start to transfer data"
...
.method public static translateResponseCode(I)I
    ...
    const-string/jumbo v1, "processing http code %d"
