...
# instance fields
.field public mCatchDragList:Ljava/util/List;
...
.method public onDragDone(Z)V
    ...
    const-string/jumbo v2, "onDone dragUp : "
    ...
    invoke-virtual {p1, v0}, Lcom/android/camera/ui/DragLayoutBar;->start(I)Z
...
.method public onDragProgress(IZ)V
    ...
    invoke-static {p1}, Lcom/android/camera/ui/DragLayout;->access$700(Lcom/android/camera/ui/DragLayout;)Ljava/util/List;
    ...
    invoke-interface {v1, v2, p2}, Lcom/android/camera/ui/DragLayout$OnDragListener;->onDragProgress(IZ)V
...
.method public onDragStart(Z)V
    ...
    const-string/jumbo v2, "onStart dragUp : "
    ...
    invoke-interface {v1, p1}, Lcom/android/camera/ui/DragLayout$OnDragListener;->onDragStart(Z)V
...
.method public promptExpand(Ljava/lang/Runnable;)V
    ...
    const-string/jumbo v1, "promptExpand"
    ...
    invoke-interface {v1, p1}, Lcom/android/camera/ui/DragLayout$OnDragListener;->onPromptExpand(Ljava/lang/Runnable;)V
...
.method public promptShrink(ZLjava/lang/Runnable;)V
    ...
    const-string/jumbo v1, "promptShrink"
    ...
    invoke-interface {v1, p1, p2}, Lcom/android/camera/ui/DragLayout$OnDragListener;->onPromptShrink(ZLjava/lang/Runnable;)V
